...
8. WHEN the user selects 'Random Disk', THE SYSTEM SHALL generate a disk-shaped seeding area scaled by `seedScale` and apply it at the impact point [Acceptance: seeded cells count and distribution approximate a disk shape].
